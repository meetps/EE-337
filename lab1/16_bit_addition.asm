...
ADDER_16BIT:
	...
	MOV 64H,A
	MOV A,60H
	ADDC A,70H ;	but will be needed later 	
	MOV 63H,A
	JB PSW.2 , RETURN
	RET
...
INIT:
		MOV 60H,#80H   ;-- store the numbers to be added/subtracted at appropriate location
		MOV 61H,#0FCH   ;-- store the numbers to be added/subtracted at appropriate location
		MOV 70H,#80H
		MOV 71H,#32H
	RET
